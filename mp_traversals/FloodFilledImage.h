...
private:
  PNG* initialPic;
  std::vector<ImageTraversal *> its;
  std::vector<ColorPicker *> cps;
  // std::vector<PNG> frames; not needed
  // need vector for traversals and colorpickers, look at note at top
	/** @todo [Part 2] */
