...
TEST_CASE("List::reverse with numbers", "[weight=5][part=2]") {
  List<int> list;
...
TEST_CASE("List::reverseNth with numbers", "[weight=5][part=2]") {
  List<int> list;
  for (unsigned i = 1; i < 7; i++) { list.insertBack(i); }
